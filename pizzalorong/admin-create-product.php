								...
								<div class="card-body pt-4 pb-3">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" name="menu_name" placeholder="Menu Name" class="form-control" value="<?php echo (!empty($article['name']) ? $article['name'] : ''); ?>"/>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Price</label>
                                            <input required type="number" name="menu_price" placeholder="Menu Price" class="form-control" value="<?php echo (!empty($article['price']) ? $article['price'] : ''); ?>"/>
                                        </div>
