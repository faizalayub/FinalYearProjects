<?php
    ...
    if(isset($_POST['login_submit'])){
        ...
        if(!empty($result)){
            ...
            echo '<script>alert("Success");window.location.href="navigation-admin.php"</script>';
        }else{
            echo '<script>alert("Invalid credential, Please try again");window.location.href="login-admin.php"</script>';
        }
    }
?>
