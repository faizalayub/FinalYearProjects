<?php
    ...
    $_SESSION['customer_session'] = 15;
    $_SESSION['dine_table'] = ($_GET['table'] ?? '');
?>
                        ...
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mb-3 text-center">Selection Menu</h4>
                                    <hr><br>

                                    <!--#Category Tab -->
                                    <ul class="pagination pagination-lg d-flex flex-wrap gap-1">
                                        <?php
                                    ...
                                    <!--#Search Key -->
                                    <form method="GET" class="d-flex gap-3 mb-2 flex-column">
