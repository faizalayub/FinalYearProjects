                                            ...
                                            <div class="table-responsive">
                                                <table class="w-100 table table-bordered table-striped table-hover">
                                                    ...
                                                    <?php
                                                        ...
                                                        $customers = fetchRows("SELECT `id` FROM `login` WHERE `type` = 3 OR `type` = 4");
                                                        ...
                                                        <td align="left" class="py-2 surface-0 px-3 border-bottom-1 border-300">
                                                            <?php
                                                                switch($orderuser['type']){
                                                                    ...
                                                                    case 4:
                                                                        echo '
                                                                        <span class="badge badge-info-light">Dine-In</span>
                                                                        <span class="text-mute">Table: '.$value['dine_in_table'].'</span>';
                                                                    break;
                                                                }
                                                            ?>
                                                        </td>
