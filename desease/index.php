            ...
            <center>
                <table border="0">
                    <tr>
                        ...
                        <td  width="10%">
                            <a href="register-account.php" class="non-style-link">
                    ...
                    <tr>
                        <td colspan="3">
                            <center>
                                ...
                                <input type="button" value="Check Disease" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                                </a>
                            </center>
                        </td>
                    </tr>
