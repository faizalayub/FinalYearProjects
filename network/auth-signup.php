...
<body>
								...
								<div class="card">
									<div class="card-body">
										<div class="m-sm-4">
											...
											<!--#START Header -->
                                            <h1 class="h3 w-100 text-center">Register As New Student</h1>
                                            <!--#END Header -->
											...
											<form method="POST">
												<div class="mb-3">
													...
													<input class="form-control form-control-lg" type="text" name="studentid" placeholder="Enter your student id">
												</div>
												<div class="mb-3">
    ...
    <?php
        if(isset($_POST['create_account'])){
            ...
            $result = runQuery("INSERT INTO `login` (`id`, `name`, `email`, `password`, `type`, `phone`, `address`, `studentID`) VALUES (NULL, '$name', '$email', '$password', '3', '$phone', '$address', '$id')");
