                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Manage</strong> Study Materials</h3>
                        </div>

                        <div class="col-auto ms-auto text-end mt-n1">
							<a href="admin-add-material.php" class="btn btn-primary">Add Material</a>
						</div>
                    </div>
                    <!--#END HEADER -->
                                        ...
                                        <table id="table-content" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                                ...
                                                foreach($userrecord as $key => $value){
                                                    ...
                                                    $editButton = '<a href="./admin-add-material.php?id='.$value['id'].'"><i class="align-middle" data-feather="edit"></i></a>';
