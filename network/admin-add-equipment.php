							...
							<div class="card flex-fill">
								...
								<div class="card-body pt-4 pb-3">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <a href="admin-manage-equipment.php">
    ...
    <?php
        if(isset($_POST['add_equipment'])){
            ...
            if($isEdit){
                ...
                ToastMessage('Success', 'User Updated!', 'success', 'admin-manage-equipment.php');
            }else{
                runQuery("INSERT INTO `equipment` (`id`, `name`, `publisher`, `status`, `type`) VALUES (NULL, '$name', '$userAuth->id', '1', '$type')");

                ToastMessage('Success', 'User Added!', 'success', 'admin-manage-equipment.php');
            }
        }
    ?>
</body>
