						...
						<div class="col-xl-8 col-xxl-8">
							<form class="card flex-fill" method="POST" enctype="multipart/form-data">
								...
								<div class="card-body pt-4 pb-3">
                                    ...
                                    <div class="mb-3">
                                        <a href="admin-manage-material.php">
    ...
    <?php
        if(isset($_POST['upload_material'])){
            ...
            if(isset($_GET['id'])){
                ...
                ToastMessage('Success', 'Material Saved', 'success', 'admin-manage-material.php');
            }else{
                ...
                ToastMessage('Success', 'Material Added', 'success', 'admin-manage-material.php');
            }
        }
    ?>
</body>
