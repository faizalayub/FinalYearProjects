    ...
    <div class="grid py-6">
        ...
        <div class="col-8">
            <div class="flex align-items-center justify-content-between p-3 surface-ground border-1 border-300">
                <h3 class="m-0 p-0">List Of Admin</h3>

                <a href="admin_staff_add" class="no-underline">
                    <button class="py-2 px-3 bg-green-600 text-0 border-green-600 border-round hover:bg-green-500 border-noround border-1 border-300 cursor-pointer">Add New Admin</button>
                </a>
            </div>
            ...
            <div class="w-full h-full mt-3">
                <table class="w-full surface-ground">
                    ...
                    <?php
                        $userrecord = fetchRows("SELECT * FROM login WHERE type=1");
                    ...
                    <tr>
                        ...
                        <td class="py-2 surface-0 px-3">
                            <a href="admin_staff_add?id=<?php echo $value['id']; ?>">Edit</a>
                        </td>
                    </tr>
                    <?php } ?>
